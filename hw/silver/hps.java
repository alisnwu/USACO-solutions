...
public class hps{
	public static void main(String[] args) throws IOException{
		BufferedReader hin = new BufferedReader(new FileReader("hps.in"));
		PrintWriter hout = new PrintWriter(new BufferedWriter(new FileWriter("hps.out")));
		int N = Integer.parseInt(hin.readLine());
		int[] l = new int[N];
		int[] lReverse = new int[N];
		for(int i=0; i<N; i++){
			String s = hin.readLine();
			if(s.equals("P")) l[i] = 1;
